<div id="flipkart-navbar" class="mainmenu-area">
    <div class="container">
        <div class="row row1">
                ...
                @if(isset($user->name))
                    ...
                    <li class="upper-links dropdown"><a class="links" href="#">{{ $user->name }}</a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="profile-li"><a class="profile-links" href="{{ URL::route('produk::create') }}">Product</a></li>
                            <li class="profile-li"><a class="profile-links" href="{{ url('/logout') }}">Logout</a></li>
                        </ul>
                    </li>
                @else
                    <li class="upper-links"><a class="links" href="{{ url('/signin') }}">Login</a></li>
                    <li class="upper-links"><a class="links" href="{{ url('/register') }}">Daftar</a></li>    
                @endif
            </ul>
        </div>
        <div class="row row2">
...
<div id="mySidenav" class="sidenav">
    ...
    <a href="http://clashhacks.in/">test sidenav</a>
